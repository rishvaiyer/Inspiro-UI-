            ...
            <div class="col-md-3">
                ...
                <div class="card" style="width: 18rem;" id="divBasicParticipantProfile" runat="server">
                    <div class="card-body bg-light">
                        ...
                        <p class="card-text text-center font-weight-bold">
                            <asp:Label runat="server" ID="lblEmployer"> Employer: ShopRite</asp:Label>
                        </p>
                    </div>
                        ...
                        <div id="divDemographicInfo" class="collapse" aria-labelledby="gpDemographicInfo" data-parent="#accordionParticipantProfile">
                            <div class="card-body">
                                ...
                                <div class="row form-group required">
                                    ...
                                    <div class="col-md-6 text-uppercase font-weight-bold">
                                        <label id="lblVeteran">Veteran Staus</label>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlVeteran" CssClass="form-control edit-veteran gp-update-field selectpicker" data-selected-text-format="count > 3" multiple="multiple" disabled>
                                            <asp:ListItem Value=""> Select Veteran Status...</asp:ListItem>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        <asp:DropDownList ID="ddlLanguage" runat="server" CssClass="form-control edit-language gp-update-field selectpicker" data-selected-text-format="count > 3" multiple="multiple">
...
<asp:Content ID="Content3" ContentPlaceHolderID="EndBodyPlaceholder" runat="server">
    <script>
        ...
        var arrProfileFieldMapping = {
            'demographic-info': ['tanf', 'lnpwi', 'exoffender', 'education', 'veteran', 'ethnicity', 'race', 'language', 'disability'],
        ...
        var arrProfileHeaderMapping = {
            'divDemographicInfo': 'demographic-info',
            'divMedicalInfo': 'medical-info',
            'divFinancialInfo': 'financial-info',
            'divCaseNote': 'case-note',
            'divGoal': 'goal',     
